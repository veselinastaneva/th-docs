...
{{button: { to: "/{{handler}}/{{teachable}}/settings/deploy-keys", style={{ margin-right: '5px'}}, type: "grey", size: "small", title: "Deploy an existing model" } }} {{button: { to: "/{{handler}}/{{teachable}}/settings/deploy-keys", style={{ margin-right: '5px'}}, type: "grey", size: "small", title: "Advanced Deployment" } }} {{button: { to: "/{{handler}}/{{teachable}}/settings/deploy-keys", style={{ margin-right: '5px'}}, type: "grey", size: "small", title: "Advanced Deployment of Regression model" } }}
